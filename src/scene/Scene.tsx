...
export function Scene() {
  ...
  // a playing video texture must render every frame to advance
  const screenIsVideo = useMockupStore((s) => s.screenIsVideo);
  return (
    <Canvas
      gl={{
        antialias: true,
      ...
      frameloop={
        animate || crtEnabled || recording || filmAnim || screenIsVideo ? 'always' : 'demand'
      }
